...
?>
<div class="member-event-container">
<?php
echo $EM_Notices;
...
if( user_can($bp->displayed_user->id,'edit_events') ){
	...
	<h4><i class="far fa-calendar-alt"></i><?php _e('My Events', 'events-manager'); ?></h4>
...
if( get_option('dbem_rsvp_enabled') ){
	...
	<h4><i class="far fa-calendar-check"></i><?php _e("Events I'm Attending", 'events-manager'); ?></h4>
