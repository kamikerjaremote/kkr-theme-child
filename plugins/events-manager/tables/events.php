					...
					foreach ( $EM_Events as $EM_Event ) {
						...
						<tr class="event <?php echo trim($class); ?>" id="event_<?php echo $EM_Event->event_id ?>">
							...
							*/ ?>
							<td>
								<strong>
									<a class="row-title"><?php echo esc_html($EM_Event->event_name); ?></a>
								</strong>
								<?php 
								...
								<div class="row-actions">
									...
									<span class="trash"><a href="<?php echo $_SERVER['REQUEST_URI'] . "?action=edit&event_id=" . $EM_Event->event_id; ?>"><?php _e('Edit','events-manager'); ?></a></span>
